    ...
    <div style={{ paddingTop: 110, paddingBottom: 80, position: "relative", zIndex: 2 }}>
      <div className="wrap">
        <div className="glass-gold" style={{ padding: "20px 26px", marginBottom: 26 }}>
          <div className="eyebrow" style={{ fontSize: 11.5 }}>Herramienta interna</div>
          ...
          <p className="body" style={{ marginTop: 10, maxWidth: 640 }}>
            ...
            <code style={{ color: "var(--oro-texto)" }}>RAW</code> en <code style={{ color: "var(--oro-texto)" }}>src/data.js</code>.
        ...
        <div className="glass" style={{ marginTop: 24, padding: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, marginBottom: 18 }}>
            <div>
              <span className="eyebrow" style={{ fontSize: 11.5 }}>Marcar vendidos</span>
              <p className="meta" style={{ marginTop: 8 }}>
                Click en un lote para cambiar su estado. Copia el bloque de abajo a <code style={{ color: "var(--oro-texto)" }}>RAW</code> en data.js.
              </p>
            </div>
            <div className="glass-pill" style={{ padding: "9px 18px", fontSize: 12.5, color: "var(--texto-2)" }}>
            ...
            {lots.map((l) => (
              <button key={l.id}
                ...
                style={{
                  ...
                  color: l.sold ? "var(--texto-3)" : "#C6D9B0",
                ...
                <span style={{ fontSize: 11, letterSpacing: "0.1em", opacity: 0.8, flexShrink: 0 }}>
                  {l.sold ? "VEND" : "LIBRE"}
                </span>
              </button>
            ))}
